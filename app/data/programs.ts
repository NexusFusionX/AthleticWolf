export const programs = [
  {
    ...
    highlights: [
      "Custom calorie and macro targets based on your body and goals",
      "Structured strength + cardio programming to preserve lean muscle while losing fat",
      "Weekly check-ins to track progress and adjust the plan as you go",
      "No crash diets, no extreme restriction — built for long-term results",
    ],
  },
  {
    ...
    highlights: [
      "Progressive strength programming tailored to your experience level",
      "Nutrition plan built to support muscle growth and recovery",
      "Form guidance and technique feedback throughout your program",
      "Flexible programming for full gym, home equipment, or bodyweight training",
    ],
  },
  {
    ...
    highlights: [
      "Precision nutrition targets to support fat loss and muscle gain together",
      "Strength-focused training to build muscle while in a controlled deficit",
      "Regular body composition check-ins, not just weight tracking",
      "Adjustments made in real time based on your progress",
    ],
  },
  {
    ...
    highlights: [
      "100% remote — train from home, a gym, or while traveling",
      "Direct access to your coach for questions and form checks",
      "Weekly check-ins and ongoing plan adjustments",
      "Works for any goal: fat loss, muscle building, or general fitness",
    ],
  },
  {
    ...
    highlights: [
      "Custom meal plans built around your food preferences and schedule",
      "Support for vegetarian, high-protein, or other dietary preferences",
      "Ongoing adjustments as your goals and progress change",
      "Practical guidance you can actually stick to long-term",
    ],
  },
];
